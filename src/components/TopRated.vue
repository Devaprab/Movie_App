    ...
    <!-- movie-details-area -->
         <section  class="movie-details-area" >
                        ...
                        <div class="row align-items-center position-relative">
                            <div class="col-xl-3 col-lg-4">
                                <div class="movie-details-img">
                                    <img :src="'https://image.tmdb.org/t/p/w500' + movie.poster_path" alt="Image Not Found">
                                </div>
                            </div>
            ...
            export default {
              ...
              async mounted() {
                let response = await axios.get('https://api.themoviedb.org/3/movie/top_rated?api_key=83b97b9cc5e49a305bad52fe127f9408');
